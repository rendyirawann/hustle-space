...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="/admin/login" class="btn btn-primary" style="margin-left: 0.5rem;">Login</a>
        </div>
    </nav>
    ...
    <section id="pricing" class="pricing">
        ...
        <div class="pricing-grid">
            ...
            <div class="pricing-card">
                ...
                <a href="/admin/login" class="btn btn-outline">Mulai Sekarang</a>
            </div>
            ...
            <div class="pricing-card popular">
                ...
                <a href="/admin/login" class="btn btn-primary">Pilih Pro</a>
            </div>
            ...
            <div class="pricing-card">
                ...
                <a href="/admin/login" class="btn btn-outline">Hubungi Kami</a>
            </div>
    ...
    <footer>
        &copy; 2024 HustleSpace. All rights reserved. Made with ❤️ for your best moments.
    </footer>
